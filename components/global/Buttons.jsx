...
export const PrimaryButton = styled(({className, color = 'white', children, type = false, onClick}) => {
  return (
    <button onClick={onClick} type={type} className={`${className} bg-accent relative py-3.5 px-14 rounded-sm font-tiny`}>
